...
import { InnerPageContainer, ListCardDivGreen, ListCardDivPink, ListCardDivYellow, ListItemSpan, ListsContainer, ListsDiv, PageSubtitleSpan, PageTitleSpan } from '../../components/GeneralSC';
